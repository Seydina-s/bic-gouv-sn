...
L'accueil est la une d'un journal du jour : un bandeau tricolore fin, le nom de l'application et la date comme un titre de quotidien, un filet noir dessous, puis une grande photo pleine largeur et un titre en serif. La une est un bandeau défilant (les 5 derniers articles avec photo, 5 s chacun, pause au toucher, bouton pause, arrêt avec « réduire les animations » ou un lecteur d'écran). Suivent la carte « Dernier Conseil des ministres », puis une rangée horizontale par rubrique (10 cartes verticales et une carte « Voir plus » aux couleurs de la rubrique) qui mène à la page de la rubrique (20 articles par page, pagination numérotée). Un petit bouton rond « Revenir en haut » apparaît en bas à droite après défilement (demande de l'utilisateur, 26/09/2026). C'est la direction D-05 choisie par l'utilisateur le 25/09/2026 : elle remplace l'ancienne direction « pagne tissé seul ».
