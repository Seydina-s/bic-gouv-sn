...
| 26/09/2026 | SET-01 🔴 Réglages en écran de verre (flou du contenu derrière) ; thème et langue en icônes côte à côte dans le style de la barre d’onglets ; retrait du texte sur le wolof sous les choix | Retour utilisateur |
| 26/09/2026 | SET-02 🔴 « À propos » : description plus riche et fidèle de l’application (UX writing, sans promesse non tenue) | Retour utilisateur |
