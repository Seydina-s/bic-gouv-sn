...
| 26/09/2026 | DEM-05 🔴 Démarches par catégories (écran d'accueil en cartes verticales avec icônes, puis démarches de la catégorie choisie) : vérifier d'abord si e-senegal.sn publie une classification officielle (non trouvée lors de la collecte), sinon soumettre la question à l'utilisateur | Retour utilisateur |
